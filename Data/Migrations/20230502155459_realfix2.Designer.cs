...
namespace AppDev.Data.Migrations
{
    ...
    [Migration("20230502155459_realfix2")]
    partial class realfix2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppDev.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("AppDev.Models.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppDev.Models.Book", null)
                        .WithMany()
